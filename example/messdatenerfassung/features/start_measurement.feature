...
Funktionalität: Messung starten
  ...
  Szenario: Messung erfolgreich starten
    Wenn eine Messung für die Vorlage "Stent-Typ-A" gestartet wird
  ...
  Szenario: Mehrere Messungen für dieselbe Vorlage starten
    Wenn eine Messung für die Vorlage "Stent-Typ-A" gestartet wird
    Und eine weitere Messung für die Vorlage "Stent-Typ-A" gestartet wird
    Dann sollten 2 Messungen für die Vorlage "Stent-Typ-A" existieren

  Szenario: Messung für nicht existierende Vorlage starten
    Wenn versucht wird eine Messung für die Vorlage "Nicht-Existent" zu starten
